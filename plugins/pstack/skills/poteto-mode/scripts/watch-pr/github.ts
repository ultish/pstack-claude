...
// Detects an automated bug-report-style review comment by content, not by a
// specific account identity — there's no portable way to know your team's
// automated-reviewer account name in advance. Widen the token list if your
// setup uses a different automated review tool with its own body markers.
