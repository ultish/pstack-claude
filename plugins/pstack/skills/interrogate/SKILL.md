...
- The user's message
- Commit messages
- PR/MR description if one exists
- The code itself
...
- **Act on**. Real issues affecting correctness, security, or maintainability given the actual goals. These would block a real PR/MR.
