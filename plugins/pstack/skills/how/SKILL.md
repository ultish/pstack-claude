...
- `model`: your configured how-explorer model (default `claude-opus-5`)
- Prompt instruction: explore and report only, do not edit or write files.
...
- `subagent_type`: `"general-purpose"`
- `model`: your configured how-explainer model (default `claude-opus-5`)
- Prompt instruction: explore and explain only, do not edit or write files.
...
- `subagent_type`: `"general-purpose"`
- `model`: your configured how-explainer model (default `claude-opus-5`)
- Prompt instruction: synthesize and write the explanation only, do not edit or write repo files.
...
- Prompt instruction: critique only, do not edit or write files.
