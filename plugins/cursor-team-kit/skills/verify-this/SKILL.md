...
- CLI/TUI behavior: the **control-cli** skill, terminal transcript, or demo recording.
- UI behavior: the **control-ui** skill, screenshots, accessibility snapshots, or browser traces.
